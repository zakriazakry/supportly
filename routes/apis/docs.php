...
Route::controller(WhatsappDocsController::class)->middleware([APIKeyVaildatorMiddleware::class, 'feature:whatsapp,whatsapp_developer'])->prefix('v1/whatsapp-developer')->group(function () {
