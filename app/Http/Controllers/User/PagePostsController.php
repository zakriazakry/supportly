...
class PagePostsController extends Controller
{
    ...
    public function updateSettings(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'like_comment_enabled' => 'nullable|boolean',
            'reply_to_comment_enabled' => 'nullable|boolean',
            'reply_to_private_message_enabled' => 'nullable|boolean',
            'mention_enabled' => 'nullable|boolean',
        ...
        $post = $request->user()->posts()->updateOrCreate(
            ...
            [
                ...
                'like_comment_enabled' => $request->like_comment_enabled ?? false,
                'reply_to_comment_enabled' => $request->reply_to_comment_enabled ?? false,
                'reply_to_private_message_enabled' => $request->reply_to_private_message_enabled ?? false,
                'mention_enabled' => $request->mention_enabled ?? false,
